...
<div class="wp-block-group alignwide tn-breaking-news has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"className":"tn-section-title","layout":{"type":"flex","justifyContent":"space-between"}} --><div class="wp-block-group tn-section-title"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Última hora</h3><!-- /wp:heading --><!-- wp:paragraph {"fontSize":"sm"} --><p class="has-sm-font-size">Alertas y cobertura inmediata</p><!-- /wp:paragraph --></div><!-- /wp:group --><!-- wp:query {"query":{"perPage":5,"postType":"post","order":"desc","orderBy":"date"}} -->
