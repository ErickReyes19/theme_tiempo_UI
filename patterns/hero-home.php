...
<div class="wp-block-column" style="flex-basis:35%"><!-- wp:heading {"level":4} --><h4 class="wp-block-heading">Titulares</h4><!-- /wp:heading --><!-- wp:query {"query":{"perPage":6,"offset":1,"postType":"post","order":"desc","orderBy":"date"}} -->
